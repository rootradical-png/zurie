...
try {
    ...
    if ($selectedDb !== '' && $selectedMatrik !== '') {
        ...
        $studentPhotoFile = ik_student_photo_file($config, $student);
        $studentPhotoUri = ik_asset_data_uri($studentPhotoFile);
...
<div class="student-summary"><div class="info-grid">
...
</div><div><?php if ($studentPhotoUri !== ''): ?><img class="student-photo" src="<?= $studentPhotoUri ?>" alt="Gambar pelajar"><?php else: ?><div class="student-photo-empty">Gambar tidak ditemui</div><?php endif; ?></div></div>
