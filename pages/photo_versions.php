...
?>
<form id="pelajar-<?= pv_h($matrik) ?>" class="group <?= pv_h($groupClass) ?>" method="post" onsubmit="return confirm('Gunakan gambar pilihan sebagai <?= pv_h($matrik) ?>.jpg? Semua versi lain akan cuba diarkib. Jika arkib gagal, fail tidak dipilih tetap akan dipadam dari SFTP.');">
